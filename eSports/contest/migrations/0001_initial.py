# Generated by Django 2.2.3 on 2019-09-15 12:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2019, 9, 15, 16, 27, 16, 192084))),
                ...
                ('host', models.OneToOneField(default='GevorgArtenyan', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Match',
